...
// the file descriptor.
func NewLoopbackFile(fd int, cli *logic.NotifyServiceClient, path string) fs.FileHandle {
	return &loopbackFile{fd: fd, cli: cli, path: path}
}
